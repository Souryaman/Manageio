...
import com.example.manageio.adapters.TaskListItemsAdapter
import com.example.manageio.firebase.FirestoreClass
import com.example.manageio.models.Board
import com.example.manageio.models.Card
import com.example.manageio.models.Task
...
class TaskListActivity : BaseActivity() {
    ...
    private fun setupActionBar() {
        setSupportActionBar(taskList_toolbar)
        ...
        taskList_toolbar.setNavigationOnClickListener {
            onBackPressed()
    ...
    companion object{
        const val MEMBER_REQUEST_CODE : Int = 123
        const val CARD_DETAILS_REQUEST_CODE : Int = 133
    }
}